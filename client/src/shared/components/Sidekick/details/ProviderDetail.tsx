...
import { Check, X, AlertCircle, Shield, KeyRound, Trash2, RefreshCw, Clock, Globe, Server } from 'lucide-react';
...
export function ProviderDetail({ providerId, onClose }: ProviderDetailProps) {
