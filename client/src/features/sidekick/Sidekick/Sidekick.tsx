...
import { X, Copy, Check, ChevronDown, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function SidekickSection({ title, icon, children, defaultOpen = true }: { title: string; icon?: ReactNode; children: ReactNode; defaultOpen?: boolean }) {
