...
export function SSHTerminal({ 
  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a]">
      {/* Status bar */}
      <div className="flex items-center justify-between px-4 py-2 bg-machine-card border-b border-machine-border">
        <div className="flex items-center gap-3">
          <div className={`w-2 h-2 rounded-full ${
            status === 'connected' ? 'bg-status-running animate-pulse' :
