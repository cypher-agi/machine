...
import { TerraformService, getCredentials, LogCallback } from './terraform';
import type { 
  Machine, 
  Deployment, 
  SSHKey,
...
export async function syncMachinesWithProvider(): Promise<{ synced: number; results: SyncResult[] }> {
